		...
		<el-form
				...
				<div v-bind:key="item.id" v-for="item in dataList">
					...
					<div v-if="item.ask" class="left-content">
						<div style="display: flex;align-items: flex-start;">
							...
							<el-button v-else-if="item.type==4" type="primary" size="small" @click="download(item.ask)">文件预览</el-button>
						</div>
					</div>
					<div v-else class="right-content">
						<div style="display: flex;align-items: flex-start;">
							...
							<el-button v-else-if="item.type==4" type="primary" size="small" @click="download(item.reply)">文件预览</el-button>
			...
			<el-form-item :style='{"margin":"0 0 20px 0"}' label="回复" prop="reply">
				<div style="width: 100%;display: flex;align-items: center;">
					<el-input @keydown.enter="onSubmit(null,1)" v-model="ruleForm.reply" placeholder="回复" clearable></el-input>
