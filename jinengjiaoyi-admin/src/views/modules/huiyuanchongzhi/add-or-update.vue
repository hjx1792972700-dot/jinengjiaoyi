	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.chongzhibianhao" label="充值编号" prop="chongzhibianhao" >
					<el-input v-model="ruleForm.chongzhibianhao" placeholder="充值编号" readonly></el-input>
				</el-form-item>
			...
			<el-form-item class="input" v-if="type!='info'" label="套餐" prop="taocan">
				<el-input v-model="ruleForm.taocan" placeholder="套餐" clearable :readonly="ro.taocan"></el-input>
			</el-form-item>
			<el-form-item v-else class="input" label="套餐" prop="taocan">
				<el-input v-model="ruleForm.taocan" placeholder="套餐" readonly></el-input>
			</el-form-item>
			<el-form-item class="input" v-if="type!='info'"  label="充值金额" prop="chongzhijine" >
				<el-input v-model.number="ruleForm.chongzhijine" placeholder="充值金额" clearable  :readonly="ro.chongzhijine"></el-input>
			</el-form-item>
			<el-form-item v-else class="input" label="充值金额" prop="chongzhijine" >
				<el-input v-model="ruleForm.chongzhijine" placeholder="充值金额" readonly></el-input>
			</el-form-item>
			<el-form-item class="select" v-if="type!='info'" label="支付方式" prop="zhifufangshi">
				<el-select v-model="ruleForm.zhifufangshi" placeholder="请选择支付方式" clearable>
					<el-option label="微信" value="微信"></el-option>
					<el-option label="支付宝" value="支付宝"></el-option>
					<el-option label="银行卡" value="银行卡"></el-option>
				</el-select>
			</el-form-item>
			<el-form-item v-else class="input" label="支付方式" prop="zhifufangshi">
				<el-input v-model="ruleForm.zhifufangshi" placeholder="支付方式" readonly></el-input>
			</el-form-item>
			<el-form-item class="select" v-if="type!='info'" label="状态" prop="zhuangtai">
				<el-select v-model="ruleForm.zhuangtai" placeholder="请选择状态" clearable>
			...
			<el-form-item v-else class="input" label="状态" prop="zhuangtai">
				...
				<el-form-item class="input" v-else-if="ruleForm.chongzhiriqi" label="充值日期" prop="chongzhiriqi" >
		...
		methods: {
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.chongzhijine = Number('199'); 				}
			...
			async onSubmit() {
					...
					if(this.ruleForm.tupian!=null) {
						this.ruleForm.tupian = this.ruleForm.tupian.split(',').map(u => u.replace(/^\/+/, '')).join(',');
					}
