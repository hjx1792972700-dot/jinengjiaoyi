<template>
	<div class="main-content" style="min-height:100%;width:100%;padding:0;background:none;">
		...
		<template v-if="statType">
			<div class="statShow1">
				<div class="echarts1" v-if="isAuth('yonghu','用户量统计')">
			...
			<div class="chat-content" id="chat-content">
				<div v-bind:key="item.id" v-for="item in chatList">
					...
					<div v-if="item.uid==myid" class="right-content">
						...
						<el-button v-else-if="item.format==4" type="primary" size="small" @click="chatDownload(item.content)">文件预览</el-button>
	...
	export default {
		...
		methods: {
			...
			chatClick(row) {
				...
				if(row.yonghuxingming){
					this.nowname = row.yonghuxingming
				} else if(row.yonghuzhanghao){
