...
public class GlobalExceptionHandler {
    ...
    public R handleMethodArgumentNotValidException(MethodArgumentNotValidException e, HttpServletRequest request) {
        ...
        return R.error(String.format("请求地址 %s 参数校验失败：%s", requestURI, message));
    }
    ...
    public R handleBadSqlGrammarException(BadSqlGrammarException e, HttpServletRequest request) {
        ...
        return R.error(String.format("请求地址 %s 发生SQL语法错误：%s", requestURI, errorMessage));
    }
    ...
    public R handleDataIntegrityViolationException(DataIntegrityViolationException e, HttpServletRequest request) {
        ...
        String errorMessage = DatabaseErrorParser.parseDatabaseErrorMessage(e);
        e.printStackTrace();
        return R.error(String.format("请求地址 %s 数据操作异常：%s", requestURI, errorMessage));
    }
    ...
    public R handleRuntimeException(RuntimeException e, HttpServletRequest request) {
        String requestURI = request.getRequestURI();
        e.printStackTrace();
        return R.error(String.format("请求地址 %s 发生运行时异常：%s", requestURI, e.getMessage()));
    }
    ...
    public R handleException(Exception e, HttpServletRequest request) {
        String requestURI = request.getRequestURI();
        e.printStackTrace();
        return R.error(String.format("请求地址 %s 发生系统异常：%s", requestURI, e.getMessage()));
    }
