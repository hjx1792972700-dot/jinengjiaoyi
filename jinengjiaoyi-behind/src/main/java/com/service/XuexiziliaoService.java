...
public interface XuexiziliaoService extends IService<XuexiziliaoEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<XuexiziliaoEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<XuexiziliaoEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<XuexiziliaoEntity> wrapper);
