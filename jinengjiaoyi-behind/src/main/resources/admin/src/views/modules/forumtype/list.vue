	...
	<div class="main-content" style="min-height:100%;width:100%;padding:0;background:none;">
		...
		<template v-if="showFlag ">
			<div class="admin-search">
				<el-button class="btn-primary" v-if="isAuth('forumtype','新增')" size="small" :icon="Plus" @click="addOrUpdateHandler()">新增</el-button>
			...
			<div class="admin-table-wrap">
				<el-table class="tables"
					...
					<el-table-column width="300" label="操作">
						<template #default="scope">
							<el-button v-if=" isAuth('forumtype','修改') " type="warning" plain size="small" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
							<el-button v-if="isAuth('forumtype','删除')" type="danger" plain size="small" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
			</div>
