	...
	<div class="msg-form-page">
		<el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="0">
			...
			<div class="msg-section">
				<div class="msg-section-header"><el-icon><User /></el-icon><span>留言信息</span></div>
			...
			<!-- Section 2: Reply -->
			<div class="msg-section">
				<div class="msg-section-header"><el-icon><ChatDotRound /></el-icon><span>回复管理</span></div>
				<div class="msg-section-body">
			...
			<div class="msg-actions">
				<el-button v-if="type!='info'" class="msg-btn-submit" @click="onSubmit"><el-icon><Check /></el-icon> 提交回复</el-button>
				<el-button v-if="type!='info'" class="msg-btn-cancel" @click="back()"><el-icon><Close /></el-icon> 取消</el-button>
				<el-button v-if="type=='info'" class="msg-btn-cancel" @click="back()"><el-icon><Back /></el-icon> 返回列表</el-button>
			</div>
		</el-form>
	</div>
</template>
<script>
	import { User, ChatDotRound, Check, Close, Back } from '@element-plus/icons-vue'
	export default {
		data() {
			return {
				id: '',
