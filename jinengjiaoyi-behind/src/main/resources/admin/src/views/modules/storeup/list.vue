		...
		<template v-if="showFlag ">
			<div class="admin-actions">
				<div class="action-left">
					...
					<el-button class="btn-danger" size="small" v-if="isAuth('storeup','删除')" :disabled="dataListSelections.length?false:true" @click="deleteHandler()"><template #icon><Delete /></template>删除</el-button>
				</div>
			</div>
			...
			<div class="admin-table-wrap">
				<el-table
					...
					<el-table-column width="300" label="操作">
						<template #default="scope">
							<el-button size="small" v-if=" isAuth('storeup','查看')" type="success" plain @click="addOrUpdateHandler(scope.row.id,'info')">查看</el-button>
							<el-button size="small" v-if=" isAuth('storeup','修改') " type="warning" plain @click="addOrUpdateHandler(scope.row.id)">修改</el-button>




							<el-button size="small" v-if="isAuth('storeup','删除')" type="danger" plain @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
			</div>
