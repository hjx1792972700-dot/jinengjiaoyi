	...
	<div class="modern-form-page">
		<el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="0">
			...
			<div class="form-section">
				...
				<div class="section-body grid-3">
					<div class="media-card">
						<div class="media-card-title"><el-icon><Camera /></el-icon> 封面图片</div>
					...
					<div class="media-card">
						<div class="media-card-title"><el-icon><VideoCamera /></el-icon> 视频资源</div>
						<el-form-item prop="ziliaoshipin">
							...
							></file-upload>
							<el-button v-else-if="ruleForm.ziliaoshipin" class="media-action-btn" @click="download($base.url+ruleForm.ziliaoshipin)"><el-icon><VideoPlay /></el-icon> 预览视频</el-button>
							<div v-else class="media-empty">暂无视频</div>
						</el-form-item>
					</div>
					<div class="media-card">
						<div class="media-card-title"><el-icon><Folder /></el-icon> 附件文件</div>
						<el-form-item prop="ziliaofujian">
							...
							></file-upload>
							<el-button v-else-if="ruleForm.ziliaofujian" class="media-action-btn" @click="download($base.url+ruleForm.ziliaofujian)"><el-icon><Download /></el-icon> 下载附件</el-button>
			...
			<div class="form-actions">
				<el-button v-if="type!='info'" class="action-submit" @click="onSubmit"><el-icon><Check /></el-icon> 保存发布</el-button>
				<el-button v-if="type!='info'" class="action-cancel" @click="back()"><el-icon><Close /></el-icon> 取消</el-button>
				<el-button v-if="type=='info'" class="action-cancel" @click="back()"><el-icon><Back /></el-icon> 返回列表</el-button>
			</div>
		</el-form>
	</div>
</template>
