			...
			<div class="attr">
				<div class="info">
					...
					<div class="btn_box">
						...
						<el-button class="editBtn" @click="discussClick()" type="warning" v-if="btnAuth('discussxuexiziliao','查看评论')">查看评论</el-button>
					</div>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 修改
			editClick(){
				this.$router.push(`/main/discussxuexiziliaoAdd?type=edit&&id=${this.detail.id}`);
			},
			// 删除
			async delClick(){
				await this.$confirm('是否删除此学习资料评论？') .then(_ => {
