			...
			<div class="category-bar">
				...
				<div class="cate-right">
					<div class="inline-search">
						...
						<button class="inline-search-btn" type="button" @click="getForumList(1)"><el-icon><Search /></el-icon></button>
					</div>
			...
			<div class="forum-grid" v-if="forumList.length">
				<div class="forum-card" v-for="item in forumList" :key="item.id" @click="toForumDetail(item)">
					<div class="card-cover">
						...
						<div v-else class="no-cover-placeholder"><el-icon><Picture /></el-icon></div>
...
<script>
	import { Search, EditPen, Picture, User, Clock, ChatDotRound } from '@element-plus/icons-vue'
	export default {
		components: { Search, EditPen, Picture, User, Clock, ChatDotRound },
		data() {
			return {
				formSearch: {},
				title: '',
