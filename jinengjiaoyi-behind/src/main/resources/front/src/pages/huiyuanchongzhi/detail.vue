	...
	<div class="detail-page">
		...
		<div class="detail-card">
			...
			<div class="card-right">
				<div class="info-grid">
					<div class="info-item">
						<div class="info-icon"><el-icon><Tickets /></el-icon></div>
						<div class="info-body">
					...
					<div class="info-item">
						<div class="info-icon price"><el-icon><Coin /></el-icon></div>
						<div class="info-body">
					...
					<div class="info-item">
						<div class="info-icon"><el-icon><Postcard /></el-icon></div>
						<div class="info-body">
				...
				<div class="action-bar">
					<el-button class="act-btn act-edit" v-if="btnAuth('huiyuanchongzhi','修改')" @click="editClick" :icon="Edit">修改</el-button>
					<el-button class="act-btn act-del" v-if="btnAuth('huiyuanchongzhi','删除')" @click="delClick" :icon="Delete">删除</el-button>
					<el-button class="act-btn act-chapter" v-if="btnAuth('huiyuanchongzhi','章节管理')" @click="allchapterClick()" :icon="Reading">章节管理</el-button>
				</div>
			</div>
		</div>
	</div>
