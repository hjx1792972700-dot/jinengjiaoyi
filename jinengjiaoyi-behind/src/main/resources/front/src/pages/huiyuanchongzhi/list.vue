		...
		<div class="vip-center">
			...
			<template v-if="isVip && step === 0">
				<div class="vip-status-banner gold">
					...
					<div class="banner-left">
						<div class="vip-badge-icon"><el-icon><UserFilled /></el-icon></div>
				...
				<div class="perk-section">
					...
					<div class="perk-grid">
						<div class="perk-item" v-for="p in perks" :key="p.name">
							<div class="perk-ic" :class="p.cls"><el-icon><component :is="p.icon" /></el-icon></div>
				...
				<div class="record-section" v-if="dataList.length">
					...
					<div class="record-list">
						<div class="record-item" v-for="(item, i) in dataList" :key="i">
							<div class="rec-icon"><el-icon><Wallet /></el-icon></div>
							<div class="rec-body">
			...
			<template v-if="vipExpired && !isVip && step === 0">
				<div class="vip-status-banner expired">
					<div class="banner-decor"></div>
					<div class="banner-left">
						<div class="vip-badge-icon grey"><el-icon><UserFilled /></el-icon></div>
						<div class="banner-info">
			...
			<template v-if="!isVip && step === 0">
				...
				<div class="pay-section">
					...
					<div class="pay-method-list">
						<div class="pay-method-row" :class="{active: payMethod==='alipay'}" @click="payMethod='alipay'">
							<div class="pm-icon alipay-bg"><el-icon><Coin /></el-icon></div>
						...
						<div class="pay-method-row" :class="{active: payMethod==='wechat'}" @click="payMethod='wechat'">
							<div class="pm-icon wechat-bg"><el-icon><ChatDotRound /></el-icon></div>
				...
				<div class="notice-section">
					<div class="notice-header" @click="noticeOpen = !noticeOpen">
						<span>充值须知</span>
						<el-icon><ArrowUp v-if="noticeOpen" /><ArrowDown v-else /></el-icon>
					</div>
				...
				<div class="notice-section" style="margin-top: 0;">
					<div class="notice-header" @click="autoRenewOpen = !autoRenewOpen">
						<span>自动续费说明</span>
						<el-icon><ArrowUp v-if="autoRenewOpen" /><ArrowDown v-else /></el-icon>
					</div>
			...
			<template v-if="step === 1">
				<div class="scan-page">
					<div class="scan-nav">
						<span class="nav-back" @click="cancelPay"><el-icon><ArrowLeft /></el-icon> 返回</span>
						<span class="nav-title">扫码支付</span>
					</div>

					<div class="scan-card">
						<div class="scan-method-bar" :class="payMethod">
							<el-icon><Coin v-if="payMethod==='alipay'" /><ChatDotRound v-else /></el-icon>
			...
			<template v-if="step === 2">
				<div class="success-page">
					<div class="success-icon-wrap">
						<div class="success-circle"><el-icon><Check /></el-icon></div>
					</div>
			...
			<div class="notice-modal" v-if="showNotice" @click.self="showNotice = false">
				<div class="notice-modal-content">
					<div class="nm-header">
						...
						<el-icon class="nm-close" @click="showNotice = false"><Close /></el-icon>
					</div>
