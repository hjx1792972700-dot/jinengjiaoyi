	...
	<div class="apply-detail-page">
		<div class="page-header">
			...
			<div class="header-right">
				<span class="status-badge done"><el-icon><CircleCheck /></el-icon> 已交换</span>
		...
		<div class="exchange-flow">
			...
			<div class="flow-center">
				<div class="skill-item left-skill">
					...
					<div class="skill-item-arrow"><el-icon><ArrowRight /></el-icon></div>
				</div>
		...
		<div class="detail-bottom">
			<div class="remark-card" v-if="detail.gongjineirong">
				<div class="remark-icon"><el-icon><Document /></el-icon></div>
			...
			<div class="bottom-row">
				<div class="time-info">
					<el-icon><Clock /></el-icon> 交换时间：{{detail.jiaohuanshijian || '--'}}
				</div>
			...
			<div class="review-section">
				<div class="section-title"><el-icon><ChatDotRound /></el-icon> 评价反馈</div>

				<div class="existing-review" v-if="existingReview">
					<div class="review-meta">
						<span class="reviewer-name"><el-icon><User /></el-icon> {{existingReview.jiaohuanrenxingming || existingReview.jiaohuanrenzhanghao}}</span>
						<span class="review-result good" v-if="existingReview.pingjiajieguo=='好评'"><el-icon><StarFilled /></el-icon> 好评</span>
						<span class="review-result bad" v-else-if="existingReview.pingjiajieguo=='差评'"><el-icon><Star /></el-icon> 差评</span>
						<span class="review-result normal" v-else-if="existingReview.pingjiajieguo"><el-icon><Minus /></el-icon> {{existingReview.pingjiajieguo}}</span>
				...
				<div class="no-review" v-else-if="reviewLoaded">
					<el-icon><InfoFilled /></el-icon> 暂无评价
				</div>
