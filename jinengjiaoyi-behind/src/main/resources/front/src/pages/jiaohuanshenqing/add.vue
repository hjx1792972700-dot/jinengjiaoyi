	...
	<div class="apply-page">
		...
		<div class="apply-body">
			<div class="info-cards">
				<div class="info-card skill-card">
					...
					<div class="card-info">
						...
						<div class="card-meta">
							<span class="meta-tag"><el-icon><CollectionTag /></el-icon> {{ruleForm.jinengfenlei || '—'}}</span>
							<span class="meta-tag"><el-icon><Document /></el-icon> {{ruleForm.xuqiubianhao || '—'}}</span>
						</div>
						<div class="card-row">
							<span><el-icon><User /></el-icon> {{ruleForm.yonghuxingming || '—'}}</span>
						</div>
						<div class="card-row">
							<span><el-icon><Phone /></el-icon> {{ruleForm.shoujihao || '—'}}</span>
						</div>
					</div>
				</div>
				...
				<div class="info-card user-card">
					...
					<div class="card-info">
						...
						<div class="card-meta">
							<span class="meta-tag"><el-icon><Avatar /></el-icon> {{ruleForm.gongjirenxingming || '—'}}</span>
						</div>
						<div class="card-row">
							<span><el-icon><Phone /></el-icon> {{ruleForm.lianxifangshi || '—'}}</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="apply-time">
				<el-icon><Clock /></el-icon> 申请时间：{{ruleForm.shenqingshijian}}
			</div>
