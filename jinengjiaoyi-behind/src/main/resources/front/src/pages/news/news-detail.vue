			...
			<div class="nd-card">
				...
				<div class="nd-meta">
					<span class="nd-meta-item" v-if="detail.addtime">
						<el-icon><Clock /></el-icon> {{detail.addtime.split(' ')[0]}}
					</span>
					<span class="nd-meta-item" v-if="detail.name">
						<el-icon><User /></el-icon> {{detail.name}}
					</span>
...
<script>
	import { ArrowLeft, ArrowRight, Clock, User, CollectionTag } from '@element-plus/icons-vue'
	export default {
		components: { ArrowLeft, ArrowRight, Clock, User, CollectionTag },
		data() {
			return {
				id: 0,
				detail: {},
