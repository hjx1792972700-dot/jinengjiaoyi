		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('newstype','新增')" type="primary" @click="add('/main/newstypeAdd')">
				...
				<el-table class="tables" :stripe='false'
					...
					<el-table-column width="300" label="操作">
						<template #default="scope">
							...
							<el-button class="table-btn5" type="success" @click="chapterClick(scope.row)" v-if="btnAuth('newstype','章节管理')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`newstype/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(async res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/main/newstypeDetail', query: params});
			},
			...
			chapterClick (row){
				...
				this.$router.push({path: '/main/chapternewstype', query: params});
			},
		}
	}
</script>
