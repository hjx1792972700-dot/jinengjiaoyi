...
<script>
	...
	import jiansheImg from '@/assets/jianshe.png'
	import nongyeImg from '@/assets/nongye.png'
	import zhongguoImg from '@/assets/zhongguo.png'
	import jiaotongImg from '@/assets/jiaotong.png'
