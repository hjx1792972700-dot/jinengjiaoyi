			...
			<div class="storeup-card-item" v-for="(item, index) in storeupList" :key="index" @click="toDetail(item)">
				<el-card class="storeup-card">
					<div class="card-img-wrap">
						...
						<div class="no-image" v-else><el-icon><Picture /></el-icon></div>
...
<script>
	...
	import { StarFilled, Star, Menu, Goods, ChatDotRound, Reading, Picture } from '@element-plus/icons-vue'
	export default {
