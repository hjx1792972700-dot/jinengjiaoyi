		...
		<div class="sort-bar-wrap">
			...
			<div class="sort-bar-right">
				<div class="inline-search">
					...
					<button class="inline-search-btn" @click="getList(1, curFenlei)"><el-icon><Search /></el-icon></button>
				</div>
			</div>
		</div>
		<div class="list">
			<div class="list5">
				<div v-for="(item,index) in dataList" :key="index" class="list-item" @click.stop="toDetail(item)" >
					...
					<div class="infoBox">
						...
						<div class="card-meta">
							<span class="meta-time"><el-icon><Clock /></el-icon>{{item.addtime?item.addtime.split(' ')[0]:''}}</span>
						</div>
						<div class="card-stats">
							<span class="stat-item"><el-icon><View /></el-icon>{{item.clicknum||0}}</span>
							<span class="stat-item"><el-icon><Star /></el-icon>{{item.storeupnum||0}}</span>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import { Search, Clock, View, Star } from '@element-plus/icons-vue';
	import * as echarts from 'echarts'
	import chinaJson from "@/common/echarts/china.json";
	export default {
		components: { Search, Clock, View, Star },
		//数据集合
		data() {
			return {
				layouts: '',
