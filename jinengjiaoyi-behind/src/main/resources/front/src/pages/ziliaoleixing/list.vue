		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item" >
					<div class="lable">资料类型：</div>
					<el-input v-model="formSearch.ziliaoleixing" placeholder="资料类型" @keydown.enter="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('ziliaoleixing','新增')" type="primary" @click="add('/main/ziliaoleixingAdd')">
				...
				<el-table class="tables" :stripe='false'
					...
					<el-table-column width="300" label="操作">
						<template #default="scope">
							...
							<el-button class="table-btn5" type="success" @click="chapterClick(scope.row)" v-if="btnAuth('ziliaoleixing','章节管理')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`ziliaoleixing/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(async res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/main/ziliaoleixingDetail', query: params});
			},
			...
			chapterClick (row){
				...
				this.$router.push({path: '/main/chapterziliaoleixing', query: params});
			},
		}
	}
</script>
