<template>
	<div>
		...
		<el-upload ref="upload" :action="getActionUrl" list-type="picture-card" accept=".xls,.xlsx" :limit="limit"
			:headers="myHeaders" :on-exceed="handleExceed" :on-preview="handleUploadPreview" :on-remove="handleRemove"
			:on-success="handleUploadSuccess" :on-error="handleUploadErr" :before-upload="handleBeforeUpload"
			:show-file-list="false">
			<i class="el-icon-plus"></i>
			<template #tip><div class="el-upload__tip" style="color:#838fa1;">{{tip}}</div></template>
		</el-upload>
		<el-dialog :visible.sync="dialogVisible" width="420px" append-to-body>
