    ...
    <div class="captcha-overlay" v-if="visible" @click.self="close">
      <div class="captcha-modal">
        <div class="captcha-header">
          ...
          <i class="el-icon-close captcha-close-btn" @click="close"></i>
        </div>
        <div class="captcha-body">
          ...
          <div class="canvas-container">
            ...
            <transition name="captcha-fade">
              <div v-if="statusTip" class="status-tip" :class="statusClass">
                <i :class="statusClass === 'success' ? 'el-icon-circle-check' : 'el-icon-circle-close'"></i>
                {{ statusTip }}
              </div>
            </transition>
          </div>
          <div class="slider-box">
            <div class="slider-track">
              ...
              <div class="slider-thumb" :class="[statusClass, {dragging: dragging}]"
                ...
                <i :class="'el-icon-' + thumbIconComp"></i>
              </div>
            </div>
          ...
          <div class="captcha-footer">
            <span class="refresh-link" @click="reset">
              <i class="el-icon-refresh-right"></i> 换一张
            </span>
          </div>
        </div>
      </div>
