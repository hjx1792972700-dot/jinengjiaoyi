		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item" >
					...
					<el-input v-model="formSearch.typename" placeholder="分类名称" @keydown.enter="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('forumtype','新增')" type="primary" @click="add('/main/forumtypeAdd')">
				...
				<el-table class="tables" :stripe='false'
					...
					<el-table-column width="300" label="操作">
						<template #default="scope">
							...
							<el-button class="table-btn5" type="success" @click="chapterClick(scope.row)" v-if="btnAuth('forumtype','章节管理')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`forumtype/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(async res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/main/forumtypeDetail', query: params});
			},
			...
			chapterClick (row){
				...
				this.$router.push({path: '/main/chapterforumtype', query: params});
			},
		}
	}
</script>
