		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('friend','新增')" type="primary" @click="add('/main/friendAdd')">
					...
					<el-table-column :resizable='true' prop="picture" width="200" label="图片">
						<template #default="scope">
							<div v-if="scope.row.picture">
								...
								<img v-else :src="baseUrl+scope.row.picture.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(baseUrl+scope.row.picture.split(',')[0])">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`friend/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(async res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/main/friendDetail', query: params});
			},
