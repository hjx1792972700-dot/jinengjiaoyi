	...
	<div class="apply-detail-page">
		<div class="page-header">
			...
			<div class="header-right">
				<span class="status-badge done" v-if="detail.sfsh=='已完成'"><i class="el-icon-circle-check"></i> 已完成</span>
				<span class="status-badge confirming" v-else-if="detail.sfsh=='待确认'"><i class="el-icon-select"></i> 待确认</span>
				<span class="status-badge fail" v-else-if="detail.sfsh=='否'"><i class="el-icon-circle-close"></i> 已拒绝</span>
				...
				<div class="exchange-detail-body">
					<div class="exchange-side">
						...
						<div class="exchange-side-skill">
							...
							<div class="exchange-skill-cover placeholder" v-else><i class="el-icon-box"></i></div>
		...
		<div class="remark-card" v-if="detail.shenqingbeizhu">
			...
			<div class="remark-body">
				<div class="remark-title">{{detail.gongjirenxingming}} 说：</div>
		...
		<div class="remark-card reply-card" v-if="detail.shhf">
			...
			<div class="remark-body">
				<div class="remark-title">{{replyAuthor}} 说：</div>
			...
			<div class="bottom-row">
				<div class="time-info">
					<i class="el-icon-time"></i> 申请时间：{{detail.shenqingshijian || '--'}}
				</div>
		...
		<el-dialog :visible.sync="declineVisible" title="拒绝交换" width="440px" :close-on-click-modal="false" top="30vh">
...
<script>
	...
	computed: {
		...
		replyAuthor() {
			if (this.detail.xuanzejinengbiaoti) {
				return this.detail.gongjirenxingming;
			}
			return this.detail.yonghuxingming;
		},
	},
		methods: {
			init() {
