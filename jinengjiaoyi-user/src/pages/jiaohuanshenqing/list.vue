	...
	<div :class="{'dark-embedded': embedded}">
						...
						<div class="card-inner">
							<div class="imgbox">
								...
								<div class="card-badge">
									<i class="el-icon-circle-check"></i> 申请
								</div>
							</div>
							<div class="infoBox">
								...
								<div class="card-tags-row">
									...
									<div class="card-status done" v-if="item.sfsh=='已完成'"><i class="el-icon-circle-check"></i> 已完成</div>
									<div class="card-status confirming" v-else-if="item.sfsh=='待确认'"><i class="el-icon-select"></i> 待你确认</div>
									<div class="card-status fail" v-else-if="item.sfsh=='否'"><i class="el-icon-circle-close"></i> 已拒绝</div>
									<div class="card-status pending" v-else><i class="el-icon-time"></i> 待处理</div>
								</div>
		...
		<div class="custom-modal-mask" v-if="declineVisible" @click.self="declineVisible = false">
			<div class="custom-modal">
				<div class="cm-header">
					<span>拒绝交换</span>
					<i class="el-icon-close cm-close-icon" @click="declineVisible = false"></i>
				</div>
				<div class="cm-body">
