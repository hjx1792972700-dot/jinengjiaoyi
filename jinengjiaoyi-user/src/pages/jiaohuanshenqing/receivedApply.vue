<template>
	<div class="received-apply">
		<div class="ra-header">
			<div class="ra-title">
				<div class="title-icon"><i class="el-icon-bell"></i></div>
				...
				<div class="apply-card" v-for="item in dataList" :key="item.id"
					...
					<div class="card-status-bar">
						...
						<span class="status-indicator confirming" v-else-if="item.sfsh==='待确认'">
							<i class="el-icon-circle-check"></i>待对方确认
						</span>
						...
						<span class="card-time">
							<i class="el-icon-time"></i>{{item.shenqingshijian || item.addtime}}
						</span>
					</div>
							...
							<div class="info-bottom">
								<div class="applicant-row">
									...
									<div class="applicant-phone" v-if="item.lianxifangshi">
										<i class="el-icon-phone"></i>{{item.lianxifangshi}}
									</div>
								</div>
		...
		<div class="custom-modal-mask" v-if="rejectVisible" @click.self="rejectVisible = false">
			<div class="custom-modal reject-modal">
				<div class="cm-header">
					<span>拒绝申请</span>
					<i class="el-icon-close cm-close-icon" @click="rejectVisible = false"></i>
				</div>
				<div class="cm-body">
		...
		<div class="custom-modal-mask" v-if="selectSkillVisible" @click.self="selectSkillVisible = false">
			<div class="custom-modal select-skill-modal">
				<div class="cm-header">
					<span>选择对方技能</span>
					<i class="el-icon-close cm-close-icon" @click="selectSkillVisible = false"></i>
				</div>
				<div class="cm-body">
