		...
		<div class="msg-body-layout">
				...
				<div class="msg-scroll-area">
					<div v-for="item in infoList" :key="item.id" class="msg-card">
						<div class="msg-head">
							...
							<el-button v-if="userid==item.userid" type="text" class="msg-del" @click="delClick(item.id)"><i class="el-icon-delete"></i></el-button>
						</div>
						...
						<div v-if="item.reply" class="msg-reply">
							<div class="reply-tag"><i class="el-icon-service"></i> 管理员回复</div>
			...
			<div class="msg-side-panel">
				<div class="compose-card">
					<div class="compose-title"><i class="el-icon-edit"></i> 发表留言</div>
					...
					<div class="compose-footer">
						...
						<button class="compose-btn" type="button" @click="submitForm">
							<i class="el-icon-promotion"></i> 发布
						</button>
					</div>
				</div>

				<div class="tips-card">
					<div class="tips-title"><i class="el-icon-info"></i> 温馨提示</div>
					<ul class="tips-list">
						<li>留言内容请文明用语</li>
						<li>可附带一张图片</li>
						<li>管理员会尽快回复</li>
