			...
			<div class="top-bar">
				...
				<div class="search-row">
					<div class="inline-search">
						...
						<button class="inline-search-btn" type="button" @click="getNewsList(1)"><i class="el-icon-search"></i></button>
					</div>
				</div>
			</div>
						...
						<div class="slide">
							...
							<div class="slide-content">
								...
								<div class="slide-meta">
									<span class="meta-item"><i class="el-icon-user"></i> {{item.name}}</span>
									<span class="meta-item"><i class="el-icon-time"></i> {{item.addtime ? item.addtime.split(' ')[0] : ''}}</span>
								</div>
								<div class="read-btn" @click="toNewsDetail(item)">阅读全文 <i class="el-icon-arrow-right"></i></div>
							</div>
						</div>
					</el-carousel-item>
				</el-carousel>
