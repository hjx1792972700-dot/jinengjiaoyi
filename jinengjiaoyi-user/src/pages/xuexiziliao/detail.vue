	...
	<div class="detail-page">
		...
		<div class="detail-card">
			...
			<div class="card-info">
				...
				<div class="meta-tags">
					<span class="tag"><i class="el-icon-collection-tag"></i> {{detail.ziliaoleixing || "—"}}</span>
					...
					<span class="tag price-tag" v-if="detail.jiage > 0"><i class="el-icon-coin"></i> &#165;{{detail.jiage}}</span>
					<span class="tag free-tag" v-else><i class="el-icon-present"></i> 免费</span>
				</div>

				<div class="bottom-bar">
					<div class="action-bar">
						<el-button class="act-btn act-download" size="small" icon="el-icon-download"
							:disabled="!detail.ziliaofujian" @click="download(detail.ziliaofujian)">下载附件</el-button>
						<el-button class="act-btn act-edit" size="small" v-if="btnAuth('xuexiziliao','修改')" @click="editClick" icon="el-icon-edit">修改</el-button>
						<el-button class="act-btn act-del" size="small" v-if="btnAuth('xuexiziliao','删除')" @click="delClick" icon="el-icon-delete">删除</el-button>
						<el-button class="act-btn act-chapter" size="small" @click="allchapterClick()" v-if="btnAuth('xuexiziliao','章节管理')" icon="el-icon-reading">章节</el-button>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="comment-item" v-for="item in infoList" :key="item.id"
							...
							<div class="comment-right">
								...
								<div class="comment-footer">
									...
									<el-button class="del-comment" size="small" icon="el-icon-delete"
		...
		<el-dialog title="购买学习资料" :visible.sync="purchaseDialogVisible" width="420px" :close-on-click-modal="false" class="purchase-dialog">
