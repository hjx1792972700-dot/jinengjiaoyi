		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('yonghu','新增')" type="primary" @click="add('/main/yonghuAdd')">
						<span class="icon iconfont icon-tianjia7"></span>
						新增
					</el-button>
  					<el-button class="list-static-btn" v-if="btnAuth('yonghu','用户量统计')" type="success" @click="chartDialogShow1">
	...
	export default {
		...
		methods: {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/main/yonghuDetail', query: params});
			},
